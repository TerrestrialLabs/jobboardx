import { Autocomplete, Box, Button, CircularProgress, createFilterOptions, FilledInput, FormControl, MenuItem, Select, SelectChangeEvent, TextField, Typography } from '@mui/material'
