...
const Privacy: NextPage = () => {
    return (
        <div className={homeStyles.container}>
            <Head>
                <title>React Jobs | Privacy Policy</title>
                ...
                <Grid container justifyContent='center' pt={1} pb={2}>
                    <Grid xs={11} sm={10}>
                        <Box>
                            ...
                            <h1 className={styles.headerone}>Collecting and Using Your Personal Data</h1>
                            <h2 className={styles.headertwo}>Types of Data Collected</h2>
                            <h3>Personal Data</h3>
                            ...
                            <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" rel="external noreferrer nofollow noopener" target="_blank">TermsFeed website</a> article.</p>
                            ...
                            <h2 className={styles.headertwo}>Use of Your Personal Data</h2>
                            ...
                            <h2 className={styles.headertwo}>Retention of Your Personal Data</h2>
                            ...
                            <h2 className={styles.headertwo}>Transfer of Your Personal Data</h2>
                            ...
                            <h2 className={styles.headertwo}>Delete Your Personal Data</h2>
                            ...
                            <h2 className={styles.headertwo}>Disclosure of Your Personal Data</h2>
                            ...
                            <h2 className={styles.headertwo}>Security of Your Personal Data</h2>
                            <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                            <h1 className={styles.headerone}>Detailed Information on the Processing of Your Personal Data</h1>
                            <p>The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process and transfer information about Your activity on Our Service in accordance with their Privacy Policies.</p>
                            <h2 className={styles.headertwo}>Analytics</h2>
                            ...
                            <p>For more information on the privacy practices of Google, please visit the Google Privacy &amp; Terms web page: <a href="https://policies.google.com/privacy" rel="external noreferrer nofollow noopener" target="_blank">https://policies.google.com/privacy</a></p>
                            </li>
                            </ul>
                            <h2 className={styles.headertwo}>Email Marketing</h2>
                            ...
                            <p>Their Privacy Policy can be viewed at <a href="https://stripe.com/us/privacy" rel="external noreferrer nofollow noopener" target="_blank">https://stripe.com/us/privacy</a></p>
                            </li>
                            </ul>
                            <h1 className={styles.headerone}>GDPR Privacy</h1>
                            <h2 className={styles.headertwo}>Legal Basis for Processing Personal Data under GDPR</h2>
                            ...
                            <h2 className={styles.headertwo}>Your Rights under the GDPR</h2>
                            ...
                            <h2 className={styles.headertwo}>Exercising of Your GDPR Data Protection Rights</h2>
                            <p>You may exercise Your rights of access, rectification, cancellation and opposition by contacting Us. Please note that we may ask You to verify Your identity before responding to such requests. If You make a request, We will try our best to respond to You as soon as possible.</p>
                            <p>You have the right to complain to a Data Protection Authority about Our collection and use of Your Personal Data. For more information, if You are in the European Economic Area (EEA), please contact Your local data protection authority in the EEA.</p>
                            <h1 className={styles.headerone}>CCPA Privacy</h1>
                            <p>This privacy notice section for California residents supplements the information contained in Our Privacy Policy and it applies solely to all visitors, users, and others who reside in the State of California.</p>
                            <h2 className={styles.headertwo}>Categories of Personal Information Collected</h2>
                            ...
                            <h2 className={styles.headertwo}>Sources of Personal Information</h2>
                            ...
                            <h2 className={styles.headertwo}>Use of Personal Information for Business Purposes or Commercial Purposes</h2>
                            ...
                            <h2 className={styles.headertwo}>Disclosure of Personal Information for Business Purposes or Commercial Purposes</h2>
                            ...
                            <h2 className={styles.headertwo}>Sale of Personal Information</h2>
                            ...
                            <h2 className={styles.headertwo}>Share of Personal Information</h2>
                            ...
                            <h2 className={styles.headertwo}>Sale of Personal Information of Minors Under 16 Years of Age</h2>
                            ...
                            <h2 className={styles.headertwo}>Your Rights under the CCPA</h2>
                            ...
                            <h2 className={styles.headertwo}>Exercising Your CCPA Data Protection Rights</h2>
                            <p>In order to exercise any of Your rights under the CCPA, and if You are a California resident, You can contact Us:</p>
                            <ul>
                            <li>By visiting this page on our website: <a href="https://www.reactdevjobs.com/contact" rel="external noreferrer nofollow noopener" target="_blank">https://www.reactdevjobs.com/contact</a></li>
                            </ul>
                            ...
                            <h2 className={styles.headertwo}>Do Not Sell My Personal Information</h2>
                            ...
                            <ul>
                            <li>The NAI's opt-out platform: <a href="http://www.networkadvertising.org/choices/" rel="external noreferrer nofollow noopener" target="_blank">http://www.networkadvertising.org/choices/</a></li>
                            <li>The EDAA's opt-out platform <a href="http://www.youronlinechoices.com/" rel="external noreferrer nofollow noopener" target="_blank">http://www.youronlinechoices.com/</a></li>
                            <li>The DAA's opt-out platform: <a href="http://optout.aboutads.info/?c=2&amp;lang=EN" rel="external noreferrer nofollow noopener" target="_blank">http://optout.aboutads.info/?c=2&amp;lang=EN</a></li>
                            </ul>
                            ...
                            <h1 className={styles.headerone}>&quot;Do Not Track&quot; Policy as Required by California Online Privacy Protection Act (CalOPPA)</h1>
                            <p>Our Service does not respond to Do Not Track signals.</p>
                            <p>However, some third party websites do keep track of Your browsing activities. If You are visiting such websites, You can set Your preferences in Your web browser to inform websites that You do not want to be tracked. You can enable or disable DNT by visiting the preferences or settings page of Your web browser.</p>
                            <h1 className={styles.headerone}>Children's Privacy</h1>
                            ...
                            <h1 className={styles.headerone}>Your California Privacy Rights (California's Shine the Light law)</h1>
                            <p>Under California Civil Code Section 1798 (California's Shine the Light law), California residents with an established business relationship with us can request information once a year about sharing their Personal Data with third parties for the third parties' direct marketing purposes.</p>
                            <p>If you'd like to request more information under the California Shine the Light law, and if You are a California resident, You can contact Us using the contact information provided below.</p>
                            <h1 className={styles.headerone}>California Privacy Rights for Minor Users (California Business and Professions Code Section 22581)</h1>
                            ...
                            <h1 className={styles.headerone}>Changes to this Privacy Policy</h1>
