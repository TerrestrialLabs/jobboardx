                ...
                <Grid container justifyContent='center' pt={1} pb={2}>
                    <Grid xs={11} sm={10}>
                        <Box>
                            ...
                            <ul>
                            <li>By visiting this page on our website: <a href="https://www.reactdevjobs.com/contact" rel="external nofollow noopener" target="_blank">https://www.reactdevjobs.com/contact</a></li>
                            </ul>
